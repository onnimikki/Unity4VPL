/* unity_internals_modified.h ==========================================
    Unity Project - A Test Framework for C
    Copyright (c) 2007-21 Mike Karlesky, Mark VanderVoord, Greg Williams
    [Released under MIT License. Please refer to license.txt for details]
========================================== */
#ifndef UNITY_HACK_DONT_PRINT_FILEDETAILS_IN_ERROR
#define UNITY_HACK_DONT_PRINT_FILEDETAILS_IN_ERROR  
// modifies UnityTestResultsFailBegin in unity_modified.c
// modifies UnityConcludeTest in unity_modified.c
#endif 
