...
#include "unity_modified.h"  // new version of unity.h b/c of UNITY_HACK_DONT_PRINT_FILEDETAILS_IN_ERROR 
#include <stddef.h>
...
#ifdef UNITY_HACK_DONT_PRINT_FILEDETAILS_IN_ERROR
  	// replace "was" with " but got "
  	static const char PROGMEM UnityStrWas[]                    = " but got "; // hack.  Modified by James Smith for VPL.
#else
    // keep original
    static const char PROGMEM UnityStrWas[]                    = " Was ";  // hack.  Modified by James Smith for VPL
#endif
...
/*-----------------------------------------------*/
// Function modified to reduce printed output on failed unit test. -James Smith
static void UnityTestResultsFailBegin(const UNITY_LINE_TYPE line)
{
  #ifdef UNITY_HACK_DONT_PRINT_FILEDETAILS_IN_ERROR
  	// do nothing.
  	// effectively comment out to make sure that the file and line number are not printed.
  #else
	//debug: comment out to make sure that file and line number are not printed.
...
/*-----------------------------------------------*/
// Function modified to reduce printed output on successful unit test. -James Smith
